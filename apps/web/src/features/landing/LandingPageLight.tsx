...
import { ShowcaseSectionLight } from './components/ShowcaseSectionLight'
import { NewsSectionLight } from './components/NewsSectionLight'
import { FooterLight } from './components/FooterLight'
import { ArrowRight } from 'lucide-react'

export function LandingPageLight() {
  return (
    <div className="min-h-screen w-full bg-white text-neutral-950 font-sans selection:bg-indigo-500 selection:text-white overflow-x-hidden">
      <NavbarLight />
      ...
      <main className="w-full">
        ...
        <section className="py-40 px-6 bg-neutral-950 text-white relative overflow-hidden">
