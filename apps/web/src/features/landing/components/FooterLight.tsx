      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="pt-8 border-t border-neutral-200 flex flex-col md:flex-row items-center justify-between gap-4 text-xs font-mono text-neutral-400 uppercase tracking-widest">
          <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4">
            ...
            <a href="https://beian.miit.gov.cn/#/Integrated/index" target="_blank" rel="noopener noreferrer" className="font-sans normal-case tracking-normal hover:text-neutral-950 transition-colors">陇ICP备19004300号</a>
          </div>
