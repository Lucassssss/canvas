...
const QUICK_TAGS = [
  ...
  { label: '街角咖啡慵懒素人', prompt: '生成一位具有极强实拍素人感的亚洲模特，面带慵懒随性的微表情，上身穿黑色吊带，短款黑色皮衣外套，肌肤保留真实的毛孔肌理与微瑕疵，拒绝塑料AI感。置身于阳光明媚的法式街角咖啡馆，采用iPhone后置摄像头直出视角的松弛感抓拍，柔和的自然光完美展现面料的生活化质感。', image: null },
