// @ts-nocheck
import * as __fd_glob_5 from "../content/news/nano-banana2-xiaohongshu-ootd.mdx?collection=docs"
...
export const docs = await create.docs("docs", "content/news", {}, {"ecommerce-guide.mdx": __fd_glob_0, "hello.mdx": __fd_glob_1, "how-to-balance-ai-ecommerce-effect-with-cost.mdx": __fd_glob_2, "image-to-image-tech.mdx": __fd_glob_3, "joii-nano-banana-pro.mdx": __fd_glob_4, "nano-banana2-xiaohongshu-ootd.mdx": __fd_glob_5, });