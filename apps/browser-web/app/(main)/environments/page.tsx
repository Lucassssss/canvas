                    ...
                    <TableCell className="text-right pr-4 sticky right-0 bg-white group-hover:bg-[#f6f9fc] shadow-[-1px_0_0_rgba(0,0,0,0.05)]">
                      <div className="flex items-center justify-end">
                        <ButtonGroup className="shadow-none rounded-md">
                          <Button size="sm" className="h-7 bg-blue-600 hover:bg-blue-700 text-white shadow-none px-3 text-xs font-normal border border-blue-700/50">
                            打开
                          </Button>

                          <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                              <Button size="sm" className="h-7 bg-blue-600 hover:bg-blue-700 text-white shadow-none px-1 border border-blue-700/50">
